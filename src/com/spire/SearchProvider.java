...
public class SearchProvider extends ContentProvider{
	...
	public static String AUTHORITY = "com.spire.SearchProvider";
    ...
    private DirectionDatabase mDirection;
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        // to get definitions...
        matcher.addURI(AUTHORITY, "direction", SEARCH_WORDS);
        matcher.addURI(AUTHORITY, "direction/#", GET_WORD);
        // to get suggestions...
    ...
    public boolean onCreate() {
    	mDirection = new DirectionDatabase(getContext());
        return true;
    }
    ...
    private Cursor getSuggestions(String query) {
      ...
      String[] columns = new String[] {
          BaseColumns._ID,
          DirectionDatabase.KEY_WORD,
          DirectionDatabase.KEY_DEFINITION,
       /* SearchManager.SUGGEST_COLUMN_SHORTCUT_ID,
                        (only if you want to refresh shortcuts) */
          SearchManager.SUGGEST_COLUMN_INTENT_DATA_ID};

      return mDirection.getWordMatches(query, columns);
    }
    ...
    private Cursor getWord(Uri uri) {
      ...
      return mDirection.getWord(rowId, columns);
    }
