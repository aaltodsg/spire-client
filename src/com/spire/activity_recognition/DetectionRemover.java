...
public class DetectionRemover
    ...
    private static final String TAG = "DetectionRemover";
    ...
    private void requestDisconnection() {
        Debug.log(TAG, "requestDisconnection()");
    ...
    {
        Debug.log(TAG, "setActivityRecognitionClient");
...
//        Log.d(ActivityUtils.APPTAG, mContext.getString(R.string.connected));
    ...
    private void continueRemoveUpdates() {
        Debug.log(TAG, "continueRemoveUpdates");
