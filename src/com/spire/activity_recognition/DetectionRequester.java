...
public class DetectionRequester
    ...
    private static final String TAG = "DetectionRequester";
    ...
    public DetectionRequester(Context context) {
        Debug.log(TAG,"Class constructor executed.");
        // Save the context
        mContext = context;
    ...
    private void continueRequestActivityUpdates() {
         ...
         */
        Debug.log(TAG, "continueRequestActivityUpdates");

        getActivityRecognitionClient().requestActivityUpdates(
                ActivityUtils.DETECTION_INTERVAL_MILLISECONDS,
                createRequestPendingIntent()); // MJR was "createRequestPendingIntent" from Citat
    ...
    private void requestConnection() {
        ...
        if (!getActivityRecognitionClient().isConnected())
    ...
    private ActivityRecognitionClient getActivityRecognitionClient() {
        Debug.log(TAG, "getActivityRecognitionClient");
...
//        Log.d(ActivityUtils.APPTAG, mContext.getString(R.string.connected));
        ...
        switch (TrackingService.mRequestType) {
            case START :
            ...
            case STOP :
                ...
                break;
            default :
                Debug.log(TAG, "Unknown request type in onConnected");
                break;
        }
...
//        Log.d(ActivityUtils.APPTAG, mContext.getString(R.string.disconnected));
    ...
    private PendingIntent createRequestPendingIntent() {
        ...
        if (getRequestPendingIntent() != null) {
            ...
            Debug.log(TAG, "createRequestPendingIntent: Returning an existing one");
            return mActivityRecognitionPendingIntent;

        // If no PendingIntent exists
        } else {
            Debug.log(TAG, "createRequestPendingIntent: Creating a new pointer.");
            ...
            setRequestPendingIntent(mActivityRecognitionPendingIntent);
            return mActivityRecognitionPendingIntent;
